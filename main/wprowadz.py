...
def wprowadz_odczyty(cur):
    ...
    for i in range(liczba_odczytow):
            ...
            cur.execute(f"""insert into odczyty (ID_klienta, Wartosc, Miejscowosc, Ulica, Nr_domu, Nr_mieszkania) values ({id_klienta}, {wartosc}, '{miejscowosc}', '{ulica}', {nr_dom}, {nr_miesz})""")
    return
